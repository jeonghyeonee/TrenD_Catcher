...
$options = [
    ...
    'stoke' => 'none', stroke-width => 0, fill => "#ffffff",
    'x' => 0, 'y' => 0
];
////////////////////////////////////////////
...
// $new_keyword = array();
// keyword_c[0] = '['k1','k2','k3','k4']'
// $keyword1 = preg_replace('/[0-9\@\'\[\" "]+/', '', $keyword_c[0]);
// $keyword2 = preg_replace('/[0-9\@\'\[\" "]+/', '', $keyword_c[1]);
// $keyword3 = preg_replace('/[0-9\@\'\[\" "]+/', '', $keyword_c[2]);
            ...
            <div class="main_first_icon">
                ...
                <div class="main_nav">
                    ...
                    <div class="main_nav_sebu">
                        ...
                        <a class="click_icon" href="main.php">Home</a>
                    </div>
                </div>
                <div class="main_app">
                    <p>Navigation</p>
                                    ...
                                    <div>
                                        ...
                                        if (count($keyword1) <5){
                                            for ($i=0;$i<count($keyword1); $i++){
                                                $keyword1[$i] = preg_replace('/[0-9\@\'\[\" "]+/', '', $keyword1[$i]);
                                    ...
                                    <?php
                                        if (count($keyword2) <5){
                                            for ($i=0;$i<count($keyword2); $i++){
                                                $keyword2[$i] = preg_replace('/[0-9\@\'\[\" "]+/', '', $keyword2[$i]);
                                    ...
                                    <?php
                                        if (count($keyword3) <5){
                                            for ($i=0;$i<count($keyword3); $i++){
                                                $keyword3[$i] = preg_replace('/[0-9\@\'\[\" "]+/', '', $keyword3[$i]);
